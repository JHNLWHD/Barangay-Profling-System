Public Class frmDrive
    ...
    Private Sub frmDrive_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            txtSearch.Text = ""
            btnNew.Text = "New"
            btnEdit.Text = "Edit"
    ...
    Private Sub btnShowRecords_Click(sender As Object, e As EventArgs) Handles btnShowRecords.Click
        Try
            frmDrive_Load(sender, e)
            frmDriveRecords.ShowDialog()
        Catch ex As Exception
        ...
        Try
            ...
            If trigger = "New" Then
                ...
                With AddressObj
                    ...
                    If txtDrive.Text <> "" Then


                        .Drive_name = txtDrive.Text
                        .Drive_status = cboStatus.Text
            ...
            Else
                ...
                With AddressObj
                    ...
                    .Iddrive = dgvSearch.SelectedRows(0).Cells(0).Value.ToString
                    If .isDriveExist(.Drive_name, "Edit", .Iddrive) = True Then
                        msg = "already exist."
                        MessageBox.Show(String.Format("{0} {1}", .Drive_name_obj, msg), My.Application.Info.Title, MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Else
                        .Drive_name = txtDrive.Text
        ...
        Try
            With AddressObj
                If txtSearch.Text.Trim.Length > 0 Then
                    .SearchDriveRecords(dgvSearch, "ALL", 1, txtSearch.Text)
                Else
    ...
    Private Sub dgvSearch_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvSearch.CellClick
        Try
            With AddressObj
                .Iddrive = dgvSearch.SelectedRows(0).Cells(0).Value.ToString
                txtDrive.Text = dgvSearch.SelectedRows(0).Cells(1).Value.ToString
    ...
    Private Sub frmDrive_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            Dispose()
        Catch ex As Exception
