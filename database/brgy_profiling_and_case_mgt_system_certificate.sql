...
CREATE TABLE `certificate` (
  ...
  PRIMARY KEY (`idcertificate`,`person_idperson`),
  KEY `fk_personid_idx` (`person_idperson`),
  CONSTRAINT `fk_personid` FOREIGN KEY (`person_idperson`) REFERENCES `person` (`idperson`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `certificate` VALUES (11,'Clearance','To Graduate',45,'2018-03-22'),(12,'Residency','',51,'2018-03-22');
