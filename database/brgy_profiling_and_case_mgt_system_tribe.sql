...
CREATE TABLE `tribe` (
  `idtribe` int(11) NOT NULL AUTO_INCREMENT,
  `tribe_name` varchar(255) DEFAULT NULL,
  `tribe_status` varchar(255) DEFAULT NULL,
  `tribe_remove_status` varchar(255) DEFAULT NULL,
  `tribe_reg_date` date DEFAULT NULL,
  PRIMARY KEY (`idtribe`)
...
INSERT INTO `tribe` VALUES (1,'Tausug','Active','False','2018-03-20'),(2,'Christian','Active','False','2018-03-20');
