...
CREATE TABLE `religion` (
  ...
  `religion_status` varchar(255) DEFAULT NULL,
  `religion_remove_status` varchar(255) DEFAULT NULL,
  `religion_reg_date` date DEFAULT NULL,
...
INSERT INTO `religion` VALUES (1,'Islam','Active','False','2018-03-20'),(2,'Roman Catholic','Active','False','2018-03-20');
