...
CREATE TABLE `employee` (
  ...
  `employee_reg_date` varchar(255) DEFAULT NULL,
  `person_idperson` int(11) NOT NULL,
  PRIMARY KEY (`idemployee`),
  KEY `fk_employee_person1_idx` (`person_idperson`),
  CONSTRAINT `fk_employee_person1` FOREIGN KEY (`person_idperson`) REFERENCES `person` (`idperson`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `employee` VALUES (1,'Barangay Captain','Active','Official','2018-03-15',1);
