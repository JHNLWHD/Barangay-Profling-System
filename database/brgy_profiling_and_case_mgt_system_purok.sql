...
CREATE TABLE `purok` (
  `idpurok` int(11) NOT NULL AUTO_INCREMENT,
  `purok_name` varchar(255) DEFAULT NULL,
  `purok_status` varchar(255) DEFAULT NULL,
  `purok_remove_status` varchar(255) DEFAULT NULL,
  `purok_reg_date` date DEFAULT NULL,
  PRIMARY KEY (`idpurok`)
